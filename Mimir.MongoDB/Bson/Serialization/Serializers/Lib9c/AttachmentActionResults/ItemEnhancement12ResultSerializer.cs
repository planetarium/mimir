...
public class ItemEnhancement12ResultSerializer : ClassSerializerBase<ItemEnhancement12Result>
{
    public static readonly ItemEnhancement12ResultSerializer Instance = new();

    public static ItemEnhancement12Result Deserialize(BsonDocument doc) => new()
    {
    ...
    public override ItemEnhancement12Result Deserialize(BsonDeserializationContext context,
    ...
    // public override void Serialize(BsonSerializationContext context, BsonSerializationArgs args, ItemEnhancement12Result value)
    // {
