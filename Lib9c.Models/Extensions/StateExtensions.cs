...
public static class StateExtensions
{
    ...
    public static IValue Serialize(this Address address) => address.Bencoded;

    public static IValue Serialize(this Address? address) => Serialize(Serialize, address);
    ...
    public static IValue Serialize(this bool boolean) => new Bencodex.Types.Boolean(boolean);

    public static IValue Serialize(this bool? boolean) => Serialize(Serialize, boolean);
    ...
    public static IValue Serialize(this long? number) => Serialize(Serialize, number);

    public static long ToLong(this IValue serialized) =>
        long.Parse(((Text)serialized).Value, CultureInfo.InvariantCulture);

    public static long? ToNullableLong(this IValue serialized) => Deserialize(ToLong, serialized);

    #endregion

    #region BigInteger

    public static IValue Serialize(this BigInteger number) => (Bencodex.Types.Integer)number;

    public static IValue Serialize(this BigInteger? number) => Serialize(Serialize, number);
    ...
    public static IValue Serialize(this decimal? number) => Serialize(Serialize, number);
    ...
    public static IValue Serialize(this string text) => (Text)text;
    ...
    public static IValue Serialize(this DateTimeOffset dateTime) =>
        new Binary(Encoding.ASCII.GetBytes(dateTime.ToString("O", CultureInfo.InvariantCulture)));

    public static IValue Serialize(this DateTimeOffset? dateTime) => Serialize(Serialize, dateTime);
    ...
    public static IValue Serialize(this Guid number) => new Binary(number.ToByteArray());

    public static IValue Serialize(this Guid? number) => Serialize(Serialize, number);

    public static Guid ToGuid(this IValue serialized) =>
        new Guid(((Binary)serialized).ToByteArray());

    public static Guid? ToNullableGuid(this IValue serialized) => Deserialize(ToGuid, serialized);
    ...
    public static IValue SerializeForLegacyEquipmentStat(this DecimalStat decimalStat) =>
        Dictionary
            .Empty.Add("type", StatTypeExtension.Serialize(decimalStat.StatType))
        ...
        return new List(
            value
                ...
                .Select(pair =>
                    (IValue)
                        Dictionary
                            .Empty.Add("material", pair.Key.Serialize())
    ...
    public static IValue Serialize(this IEnumerable<(Address, Address, IValue)> value)
    {
        ...
        {
            result = result.Add(new List(v.Item1.Serialize(), v.Item2.Serialize(), v.Item3)); // Already IValue
        }
    ...
    {
        if (serialized.ContainsKey((IKey)(Text)key) && tryParser(serialized[key], out var value))
        {
            return value;
        }
    ...
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToAddress() : defaultValue;
    }

    public static bool GetBoolean(this Dictionary serialized, string key, bool defaultValue = false)
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToBoolean() : defaultValue;
    }

    public static int GetInteger(this Dictionary serialized, string key, int defaultValue = 0)
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToInteger() : defaultValue;
    }

    public static long GetLong(this Dictionary serialized, string key, long defaultValue = 0L)
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToLong() : defaultValue;
    }
    ...
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToDecimal() : defaultValue;
    }
    ...
    {
        return serialized.ContainsKey((IKey)(Text)key) ? serialized[key].ToGuid() : defaultValue;
    }

    public static DecimalStat GetDecimalStat(
        this Dictionary serialized,
        string key,
        DecimalStat defaultValue = default
    )
    {
        return serialized.ContainsKey((IKey)(Text)key)
    ...
    public static IValue Serialize(this FungibleAssetValue value) =>
        new Bencodex.Types.List(
            new IValue[]
            {
                Nekoyume.CurrencyExtensions.Serialize(value.Currency),
                value.RawValue.Serialize(),
            }
        );

    public static IValue Serialize(this FungibleAssetValue? value) => Serialize(Serialize, value);
